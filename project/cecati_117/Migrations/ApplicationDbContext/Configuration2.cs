namespace cecati_117.Migrations.ApplicationDbContext
{
    ...
    internal sealed class Configuration2 : DbMigrationsConfiguration<cecati_117.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(cecati_117.Models.ApplicationDbContext context)
        {
            ...
            if (!context.Users.Any(u => u.UserName == "cecati117.2018@gmail.com"))
            {
                var store = new UserStore<ApplicationUser>(context);
                var manager = new UserManager<ApplicationUser>(store);
                var user = new ApplicationUser { UserName = "cecati117.2018@gmail.com", Email = "cecati117.2018@gmail.com" };

                manager.Create(user, "Educacion.8989");
